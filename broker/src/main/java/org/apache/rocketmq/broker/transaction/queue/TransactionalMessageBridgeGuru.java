...
public class TransactionalMessageBridgeGuru {
    ...
    private static final String pattern = ".*runoob.*";

    public TransactionalMessageBridgeGuru(BrokerController brokerController, MessageStore store) {
        try {
